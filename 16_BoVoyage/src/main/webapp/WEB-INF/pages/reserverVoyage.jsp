...
<body>
	...
	<div class="container" style="background-color: #F5F5DC;">
		<h1 style="color: green; text-align: center">Réservation du
			voyage</h1>
		<form:form enctype="multipart/form-data" cssClass="form-horizontal"
			method="POST" action="soumettreReserverVoyage"
			modelAttribute="vReserv">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input type="date" cssClass="form-control"
						placeholder="Date d'arrivée" path="dateArrivee" />
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-default"
						style="background-color: #90EE90;">Continuer</button>
				</div>
			</div>
		</form:form>
	</div>
