...
<h1 style="color:green;text-align:center">Réservation de l'hébergement</h1>
...
<table class="table table-bordered">
		...
		<c:forEach var="h" items="${allHeberg}">
			<tr>
				...
				<td><img src="${pageContext.request.contextPath}/hebergement/getImage?pId=${h.id}" style="width: 150px; height: 150px"/></td>
...
<h1>Veuillez selectionner l'hébergement de votre choix</h1>
	...
	<form:form cssClass="form-horizontal" method="POST"
		action="soumettreReserverHebergement" modelAttribute="hReserv" enctype="multipart/form-data">
